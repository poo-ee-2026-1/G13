...
public class TelaRH extends JPanel {
    ...
    private JComboBox<String> comboFuncao, comboDepartamento, comboNivelAtendimento;
    private JButton btnInserir, btnAtualizar, btnExcluir, btnLimpar;
    private JTextField txtBusca;
    private JButton btnBuscar, btnLimparBusca;
    
    private static final String[] NIVEL_ATENDIMENTO = {"1º Nível", "2º Nível", "3º Nível"};
    ...
    private void initComponents() {
        ...
        painelBusca.setBorder(BorderFactory.createTitledBorder("Busca de Funcionários"));
        
        painelBusca.add(new JLabel("Nome/CPF/Matrícula:"));
        ...
        // Tabela
        String[] colunas = {"ID", "Nome Completo", "CPF", "Matrícula", "Função", "Departamento", "Nível", "Login"};
    ...
    private JPanel criarPainelFormulario() {
        ...
        // Linha 3 - Departamento e Nível de Atendimento
        ...
        gbc.gridx = 2;
        panelCampos.add(new JLabel("Nível Atendimento:*"), gbc);
        comboNivelAtendimento = new JComboBox<>(NIVEL_ATENDIMENTO);
        comboNivelAtendimento.setToolTipText("Define quais OS o funcionário pode visualizar:\n" +
                                            "1º Nível: Apenas OS de 1º Nível\n" +
                                            "2º Nível: OS de 1º e 2º Nível\n" +
                                            "3º Nível: Todas as OS");
        gbc.gridx = 3;
        panelCampos.add(comboNivelAtendimento, gbc);
        ...
        JLabel lblInfo = new JLabel("Nível de Atendimento: 1º Nível vê apenas OS do 1º Nível | 2º Nível vê OS de 1º e 2º Nível | 3º Nível vê todas as OS");
    ...
    private void buscarFuncionarios() {
        ...
        List<Usuario> filtrados = usuarios.stream()
            .filter(u -> u.getNomeCompleto().toLowerCase().contains(termo) ||
                        (u.getCpf() != null && u.getCpf().contains(termo)) ||
                        (u.getMatricula() != null && u.getMatricula().toLowerCase().contains(termo)))
            .toList();
        
        tableModel.setRowCount(0);
        for (Usuario u : filtrados) {
            String nivel = u.getNivelAtendimento() != null ? u.getNivelAtendimento() : "1º Nível";
            Object[] row = {
                u.getId(),
                u.getNomeCompleto(),
                u.getCpf(),
        ...
        if (filtrados.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Nenhum funcionário encontrado com o termo: " + termo);
        }
    }
    ...
    private void carregarUsuarioSelecionado() {
        ...
        if (row >= 0) {
            ...
            if (u != null) {
                ...
                comboNivelAtendimento.setSelectedItem(u.getNivelAtendimento() != null ? u.getNivelAtendimento() : "1º Nível");
    ...
    private void inserirUsuario() {
        ...
        if (usuarioDAO.inserir(usuario)) {
            JOptionPane.showMessageDialog(this, 
                ...
                "Nível de Atendimento: " + usuario.getNivelAtendimento(),
    ...
    private void excluirUsuario() {
        ...
        int confirm = JOptionPane.showConfirmDialog(this, 
            "⚠️ ATENÇÃO: Deseja realmente excluir este funcionário?\n\n" +
    ...
    private void preencherUsuario(Usuario usuario) {
        ...
        usuario.setNivelAtendimento((String) comboNivelAtendimento.getSelectedItem());
    ...
    private boolean validarCampos() {
        ...
        if (!ValidadorDocumento.validarCPF(cpf)) {  // ou .validar(cpf)
    ...
    private void limparFormulario() {
        ...
        comboNivelAtendimento.setSelectedIndex(0);
        txtLogin.setText("");
        txtSenha.setText("");
