...
public class TelaRelatorios extends JPanel {
    ...
    private JPanel criarPainelMedicoes() {
        ...
        // CORRIGIDO: Data Início à esquerda do campo
    ...
    private JPanel criarPainelOrdens() {
        ...
        JComboBox<String> comboNivel = new JComboBox<>(new String[]{"TODOS", "1º Nível", "2º Nível", "3º Nível"});
        ...
        btnBuscarOS.addActionListener(e -> {
            ...
            if (!"TODOS".equals(nivel)) {
                ordens = ordens.stream().filter(os -> os.getTipoNivel() != null && os.getTipoNivel().equals(nivel)).toList();
            }
    ...
    private JScrollPane criarTabelaUsuarios() {
        String[] colunas = {"ID", "Nome Completo", "CPF", "Matrícula", "Função", "Nível", "Login", "Data Cadastro"};
    ...
    private void editarDepartamento(Departamento dept) {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            if (departamentoDAO.atualizar(dept)) {
                ...
                tabbedPane.insertTab(dept.getNome(), null, criarPainelDepartamento(dept.getNome()), null, currentIndex);
