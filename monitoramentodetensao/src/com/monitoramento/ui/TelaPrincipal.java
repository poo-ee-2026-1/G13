...
public class TelaPrincipal extends JFrame {
    ...
    private JPanel criarPainelBemVindo() {
        ...
        JLabel lblNivel = new JLabel("Nível de Atendimento: " + nivelUsuario, SwingConstants.CENTER);
        lblNivel.setFont(new Font("Arial", Font.PLAIN, 14));
        lblNivel.setForeground(new Color(0, 100, 0));
    ...
    private void configurarMenu() {
        ...
        JMenuItem menuFuncionarios = new JMenuItem("Funcionários");  // NOVO ITEM
        ...
        menuFuncionarios.addActionListener(e -> abrirRH());  // NOVO EVENTO
        ...
        menuCadastros.add(menuFuncionarios);  // ADICIONADO AO MENU
