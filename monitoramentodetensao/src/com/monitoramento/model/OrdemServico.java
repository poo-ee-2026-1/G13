...
public class OrdemServico {
    ...
    // Produto reservado (para conversão de orçamento)
    private int idProdutoReservado;
    private boolean produtoReservado;
    
    public OrdemServico() {
        this.produtosInstalacao = new ArrayList<InstalacaoProduto>();
    ...
    public List<InstalacaoProduto> getProdutosInstalacao() { 
        if (produtosInstalacao == null) {
            produtosInstalacao = new ArrayList<InstalacaoProduto>();
        }
    ...
    public int getIdProdutoReservado() { return idProdutoReservado; }
    public void setIdProdutoReservado(int idProdutoReservado) { this.idProdutoReservado = idProdutoReservado; }
    
    public boolean isProdutoReservado() { return produtoReservado; }
    public void setProdutoReservado(boolean produtoReservado) { this.produtoReservado = produtoReservado; }
    ...
    public String getPrioridadeExibicao() {
        if (prioridade == null) return "MÉDIA";
        switch (prioridade) {
