...
public class TelaEquipamentos extends JFrame {
    ...
    private void initComponents() {
        setTitle("Gerenciamento de Equipamentos - Usu�rio: " + usuarioLogado.getLogin());
    ...
    private void carregarEquipamentos() {
        ...
        for (Equipamento e : equipamentos) {
            ...
            String nomeCliente = cliente != null ? 
                (cliente.getTipo().equals("FISICA") ? cliente.getNome() + " " + cliente.getSobrenome() : cliente.getRazaoSocial()) : 
                "N/A";
