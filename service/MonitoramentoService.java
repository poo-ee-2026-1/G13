...
public class MonitoramentoService {
    ...
    private static final long TIMEOUT_SEM_COMUNICACAO = 2500;
    private static final long INTERVALO_MEDICAO = 500;
    ...
    public double calcularDisponibilidade(int idCliente) {
        DadosMonitoramento dados = dadosMonitoramento.get(idCliente);
        if (dados == null || dados.getContadorMedicoes() == 0) {
            return 100.0;
        }
        ...
        return (medicoesValidas * 100.0) / totalMedicoes;
    }
